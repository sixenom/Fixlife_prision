...
RegisterCommand('probartrabajo', function()
	...
	CreateThread(function()
		StartJobIntro(Config.TimePer * 1000)
	end)
	Citizen.Wait(100)
	DoScreenFadeIn(500)
...
RegisterCommand('probarcomedor', function()
	...
	Citizen.Wait(700)
	CreateThread(function()
		StartFoodIntro(Config.TimePer * 1000)
	end)
	Citizen.Wait(100)
	DoScreenFadeIn(500)
	Citizen.Wait(Config.TimePer * 1000)
...
RegisterCommand('probaraislamiento', function()
	...
	Citizen.Wait(700)
	CreateThread(function()
		StartJobIntro(Config.TimePer * 1000, Config.SolIntroCam1, Config.SolIntroCam2, Config.SolIntroCamHeading)
	end)
	Citizen.Wait(100)
	DoScreenFadeIn(500)
	Citizen.Wait(Config.TimePer * 1000)
...
RegisterCommand('probarduchas', function()
	...
	Citizen.Wait(700)
	CreateThread(function()
		StartFoodIntro(Config.TimePer * 1000, Config.ShowerIntroCenter, Config.ShowerIntroDirection, Config.ShowerIntroRadius, Config.ShowerIntroAngle, Config.ShowerIntroStartAngle)
	end)
	Citizen.Wait(100)
	DoScreenFadeIn(500)
	Citizen.Wait(Config.TimePer * 1000)
...
RegisterCommand('probarobjetos', function()
	...
	Citizen.Wait(700)
	CreateThread(function()
		StartJobIntro(Config.TimePer * 1000, Config.ItemIntroCam1, Config.ItemIntroCam2, Config.ItemIntroHeading1, Config.ItemIntroHeading2)
	end)
	Citizen.Wait(100)
	DoScreenFadeIn(500)
	Citizen.Wait(Config.TimePer * 1000)
...
RegisterCommand('probarcierre', function()
	...
	CreateThread(function()
	StartFinalOrbit((Config.FinalHeliDuration + Config.FinalHeliDescentDuration) * 1000)
	end)
	Citizen.Wait(100)
	DoScreenFadeIn(500)
			...
			if cell ~= 0 then
				...
				if Config.HaveGuide and firstTime then
					...
					if Config.Solitary then
						...
						CreateThread(function()
							StartJobIntro(perTime, Config.SolIntroCam1, Config.SolIntroCam2, Config.SolIntroCamHeading)
						end)
						Citizen.Wait(100)
						DoScreenFadeIn(1000)
					...
					if Config.Showers then
						...
						CreateThread(function()
							StartFoodIntro(perTime, Config.ShowerIntroCenter, Config.ShowerIntroDirection, Config.ShowerIntroRadius, Config.ShowerIntroAngle, Config.ShowerIntroStartAngle)
						end)
						Citizen.Wait(100)
						DoScreenFadeIn(1000)
					...
					CreateThread(function()
						StartJobIntro(perTime, Config.ItemIntroCam1, Config.ItemIntroCam2, Config.ItemIntroHeading1, Config.ItemIntroHeading2)
					end)
					Citizen.Wait(100)
					DoScreenFadeIn(1000)
